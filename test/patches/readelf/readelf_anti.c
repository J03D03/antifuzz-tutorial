...
//////////////// ANTI-TAINT-INT //////////////////
int newvar_1=0; 
if (is_32bit_elf > 0 && is_32bit_elf < 255)
{
    for (int i=0; i<=255; i++){
        if (i == is_32bit_elf){
            newvar_1 = i;
...
//////////////// ANTI-TAINT-INT //////////////////
int newvar_3=0; 
if (do_segments > 0 && do_segments < 255)
{
    for (int i=0; i<=255; i++){
        if (i == do_segments){
            newvar_3 = i;
...
//////////////// ANTI-TAINT-INT //////////////////
int newvar_4=0; 
if (do_section_details > 0 && do_section_details < 255)
{
    for (int i=0; i<=255; i++){
        if (i == do_section_details){
            newvar_4 = i;
            break;
        }
    }
...
//////////////// ANTI-TAINT-INT //////////////////
int newvar_5=0; 
if (do_debugging > 0 && do_debugging < 255)
{
    for (int i=0; i<=255; i++){
        if (i == do_debugging){
            newvar_5 = i;
